...
def main(result_path: str):
    ...
    evspi.print_results(results)
    results.to_parquet(f'result_fused_{os.path.split(result_path)[-1]}.parquet')
    return results


if __name__ == '__main__':
    for data in ['rotary', 'keti', 'soda', 'plant1', 'plant2', 'plant3', 'plant4']:
